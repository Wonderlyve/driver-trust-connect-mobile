        ...
        <Card>
          <CardContent className="p-4">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Caresse s'engage à protéger la confidentialité des données personnelles de ses utilisateurs. Cette politique explique comment nous collectons, utilisons et protégeons vos informations.
            </p>
            ...
            <p className="text-sm text-gray-600">
              Pour toute question concernant cette politique ou pour exercer vos droits, veuillez nous contacter à <span className="text-dtc-blue">privacy@caresse.com</span> ou via notre page de contact.
            </p>
          </CardContent>
        </Card>
